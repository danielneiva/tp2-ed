...
/**
 * Merges two portions of 'cons'
 * 
 * The first array is the leftmost part of the array
 * being merged
 * 
 * 
 * The second array is the rightmost part of the array
 * being merged
 * 
 */
...
void merge(Conscience *cons, int const left, int const mid, int const right)
{
    ...
    auto *leftArray = new Conscience[leftPortionSize],
         *rightArray = new Conscience[rightPortionSize];
    ...
    auto indexOfleftPortionSize = 0, // Initial index of first portion
        indexOfrightPortionSize = 0; // Initial index of second portion
